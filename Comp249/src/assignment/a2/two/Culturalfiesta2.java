...
public class Culturalfiesta2 extends Festival2 {
	 ...
	 *            festival
	 */
	public Culturalfiesta2(int year, int month, int numberOfCities, String name, double ticketPrice, int duration,
	 ...
	 */
	public Culturalfiesta2(Culturalfiesta2 otherCulturalfiesta) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())//different classes, not equal.
			return false;
		Culturalfiesta2 other = (Culturalfiesta2) obj;
	...
	public String toString() {
		return "This " + getName() + " Culturalfiesta will be held in "+ getYear() + ", " + getMonth() + " in " + getNumberOfCities() + 
